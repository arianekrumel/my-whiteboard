 ...
 * </pre>
 */
public class ListWithRetreat<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        // create new node and attach to right
        Node p = new Node();
    ...
    public final T removeRightFront() {
        ...
        // remove and reset right & lastLeft
